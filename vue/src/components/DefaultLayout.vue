      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          ...
          <div class="mt-3 px-2 space-y-1">
            <DisclosureButton @click="logout" as="a" class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700 cursor-pointer">
              Sign out
            </DisclosureButton>
          </div>
        </div>
