<template>
<div class="flex flex-col py-4 px-6 shadow-md gb-white hover:bg-gray-50 h-[470px]">
        ...
        <div class="flex justify-between items-center mt-3">
          <router-link
            ...
            class = "flex py-2 px-4 border border-transparent text-sm rounded-md text-white bg-indigo-600 hover:bg-indiho-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
